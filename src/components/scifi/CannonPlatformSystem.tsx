...
const CANNON_POSITIONS: [number, number, number][] = [
  [0, -2.25, -8],      // Center of platform
  [-2, -2.25, -7.5],   // Front left
  [2, -2.25, -7.5],    // Front right
  [-3, -2.25, -8],     // Left
  [3, -2.25, -8],      // Right
  [-2, -2.25, -8.5],   // Back left
  [2, -2.25, -8.5],    // Back right
  [0, -2.25, -7],      // Front center
  [0, -2.25, -9],      // Back center
  [-2.5, -2.25, -7],   // Far left
];
