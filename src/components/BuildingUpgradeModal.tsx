...
export const BuildingUpgradeModal: React.FC<BuildingUpgradeModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-end justify-center p-4 z-50 animate-fade-in">
      <Card className={`w-full max-w-sm backdrop-blur-md border-2 animate-slide-in-bottom ${
        realm === 'fantasy'
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-white/70">Current Production:</span>
            ...
            <div className="flex justify-between items-center">
              <span className="text-white/70">Next Level Bonus:</span>
            ...
            <div className="flex justify-between items-center">
              <span className="text-white/70">Upgrade Cost:</span>
          ...
          <Button
            onClick={onBuy}
            disabled={!canAfford}
            className={`w-full transition-all duration-300 py-3 font-bold ${
              realm === 'fantasy'
