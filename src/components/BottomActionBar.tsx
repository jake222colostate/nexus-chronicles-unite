...
export const BottomActionBar: React.FC<BottomActionBarProps> = ({
  ...
  return (
    <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 z-30">
      <div className="flex items-center gap-2 bg-black/70 backdrop-blur-xl p-2 rounded-full border border-white/20 shadow-xl"
        style={{
        ...
        <Button
          ...
          className={`h-10 px-3 rounded-full transition-all duration-500 hover:scale-105 active:scale-95 relative overflow-hidden font-bold text-sm shadow-lg ${
          ...
          style={{
            filter: currentRealm === 'fantasy' 
              ? 'drop-shadow(0 4px 16px rgba(168, 85, 247, 0.5))' 
        ...
        <Button
          ...
          style={{
            filter: currentRealm === 'scifi' 
              ? 'drop-shadow(0 4px 16px rgba(34, 211, 238, 0.5))' 
              : 'drop-shadow(0 2px 8px rgba(0,0,0,0.2))'
          }}
        >
          <span className="relative z-10 flex items-center gap-1.5 drop-shadow-sm">
