...
export const FantasyScreenshotEnvironment: React.FC<FantasyScreenshotEnvironmentProps> = ({
  ...
  return (
    <group>
      ...
      {/* Mountain system - choose between boundary or realistic */}
      {useRealisticMountains ? (
        <RealisticMountainSystem chunks={chunks} chunkSize={chunkSize} realm={realm} />
      ) : (
